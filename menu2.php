<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
  <div class="container-fluid">
    <a class="navbar-brand" href="#"><img src="img/PNG/MARY_ALY-02.png" width="95%"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarColor02">
      <ul class="navbar-nav me-auto">
        ...
        <li class="nav-item">
          <a class="nav-link" href="actualizardatos.php">Actualizar</a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="info.php">Dolencias</a>
        </li>
        <li class="nav-item">
